• Inserted sample data into the database to simulate a realistic employee dataset and implemented Create, Read, Update, and Delete operations to manage employee records effectively.
